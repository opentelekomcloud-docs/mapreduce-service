...
If you need to set **yarn.app.attempt.diagnostics.limit.kc**, go to the **All Configurations** page by referring to :ref:`Modifying Cluster Service Configuration Parameters <mrs_01_2125>` and search for the following parameters in the search box:
