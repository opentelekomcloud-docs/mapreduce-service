...
-  :ref:`Quickly Creating a Doris Cluster <mrs_01_249283>`: On the **Quick Config** tab page, you can quickly configure parameters to create Doris clusters within a few minutes. It a high-performance and real-time analytical database, based on the MPP architecture.
