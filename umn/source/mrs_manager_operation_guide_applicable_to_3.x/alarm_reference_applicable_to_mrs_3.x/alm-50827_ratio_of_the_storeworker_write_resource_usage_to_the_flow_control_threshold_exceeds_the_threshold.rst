:original_name: ALM-50827.html

.. _ALM-50827:

ALM-50827 Ratio of the StoreWorker Write Resource Usage to the Flow Control Threshold Exceeds the Threshold
===========================================================================================================

Alarm Description
-----------------

The system checks the ratio of the StoreWorker write resource usage to the flow control threshold every 30 seconds. This alarm is generated when the ratio exceeds the threshold.

This alarm is cleared when the ratio of the write resource usage to the flow control threshold falls below the threshold.
...
#. Log in to MRS Manager and choose **O&M** > **Alarm** > **Thresholds** > **MemArtsStore** > **Resources** > **Ratio of StoreWorker write resource usage to the flow control threshold (StoreWorker)**.
...
#. Wait 2 minutes and check whether the alarm is automatically cleared.
   ...
   -  If no, go to :ref:`5 <alm-50827__en-us_topic_0000002520267253_en-us_topic_0000002157418384_li10360155511379>`.

**Collect fault information.**

5. .. _alm-50827__en-us_topic_0000002520267253_en-us_topic_0000002157418384_li10360155511379:
