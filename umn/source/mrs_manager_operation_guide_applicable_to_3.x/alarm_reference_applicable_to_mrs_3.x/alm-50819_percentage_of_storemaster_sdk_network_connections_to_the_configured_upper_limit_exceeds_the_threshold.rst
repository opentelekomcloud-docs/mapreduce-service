:original_name: ALM-50819.html

.. _ALM-50819:

ALM-50819 Percentage of StoreMaster SDK Network Connections to the Configured Upper Limit Exceeds the Threshold
===============================================================================================================

Alarm Description
-----------------

The system checks the percentage of StoreMaster SDK network connections to the upper limit every 30 seconds. This alarm is generated when the percentage exceeds the threshold.

This alarm is cleared when the percentage of StoreMaster SDK network connections to the upper limit falls below the threshold.
...
#. Log in to MRS Manager and choose **O&M** > **Alarm** > **Thresholds** > **MemArtsStore** > **Resources** > **Percentage of StoreMaster SDK network connections to the configured upper limit (StoreMaster)**.
...
#. Wait 2 minutes and check whether the alarm is automatically cleared.
   ...
   -  If no, go to :ref:`5 <alm-50819__en-us_topic_0000002520267247_en-us_topic_0000002157418376_li10360155511379>`.

**Collect fault information.**

5. .. _alm-50819__en-us_topic_0000002520267247_en-us_topic_0000002157418376_li10360155511379:
