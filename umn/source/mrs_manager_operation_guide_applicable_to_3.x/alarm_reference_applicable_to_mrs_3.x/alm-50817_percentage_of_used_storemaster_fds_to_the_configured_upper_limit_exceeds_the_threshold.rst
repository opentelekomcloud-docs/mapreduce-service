:original_name: ALM-50817.html

.. _ALM-50817:

ALM-50817 Percentage of Used StoreMaster FDs to the Configured Upper Limit Exceeds the Threshold
================================================================================================

Alarm Description
-----------------

The system checks the percentage of used StoreMaster FDs to the configured upper limit every 30 seconds. This alarm is generated when the percentage exceeds the threshold.

This alarm is cleared when the percentage of used StoreMaster FDs to the configured upper limit falls below the threshold.
...
#. Log in to MRS Manager and choose **O&M** > **Alarm** > **Thresholds** > **MemArtsStore** > **Resources** > **Percentage of used StoreMaster FDs to the configured upper limit (StoreMaster)**.
...
#. Wait 2 minutes and check whether the alarm is automatically cleared.
   ...
   -  If no, go to :ref:`5 <alm-50817__en-us_topic_0000002488267380_en-us_topic_0000002157258608_li10360155511379>`.

**Collect fault information.**

5. .. _alm-50817__en-us_topic_0000002488267380_en-us_topic_0000002157258608_li10360155511379:
