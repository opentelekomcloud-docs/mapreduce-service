...
#. Log in to MRS Manager and choose **O&M** > **Alarm** > **Alarms**. In the alarm list, view the role name and obtain the IP address of the instance in **Location** of the alarm whose ID is **50229**, and check the **CurrentValue** in **Additional Information**.

   -  If **CurrentValue** is **2**, the obtained AK/SK is invalid. Go to :ref:`2 <alm-50229__en-us_topic_0000001819654780_li38093403127>`.
   -  If **CurrentValue** is **3**, OBS fails to be connected. Go to :ref:`7 <alm-50229__en-us_topic_0000001819654780_li1843117951716>`.

**The obtained AK/SK is invalid.**

2. .. _alm-50229__en-us_topic_0000001819654780_li38093403127:
...
3. Click **Access Keys** and check whether **Status** of the target key is **Enabled**.
   ...
   -  If yes, go to :ref:`4 <alm-50229__en-us_topic_0000001819654780_li1380974061214>`.
   -  If no, click **Enable** in the **Operation** column of the row containing the key.

4. .. _alm-50229__en-us_topic_0000001819654780_li1380974061214:
...
6. Wait for about 1 minute, log in to MRS Manager, choose **O&M** > **Alarm** > **Alarms**, and check whether the alarm is cleared.
   ...
   -  If no, go to :ref:`7 <alm-50229__en-us_topic_0000001819654780_li1843117951716>`.

**Failed to connect to OBS.**

7.  .. _alm-50229__en-us_topic_0000001819654780_li1843117951716:

    Check whether the network connection between the cluster and OBS is normal.

    -  If yes, go to :ref:`8 <alm-50229__en-us_topic_0000001819654780_li1443210921719>`.
    -  If no, go to :ref:`12 <alm-50229__en-us_topic_0000001819654780_li8194169123519>`.

8.  .. _alm-50229__en-us_topic_0000001819654780_li1443210921719:
...
10. In the **Content** area, search for **Action** and check whether **obs** is contained.
    ...
    -  If yes, go to :ref:`12 <alm-50229__en-us_topic_0000001819654780_li8194169123519>`.
    -  If no, go to :ref:`11 <alm-50229__en-us_topic_0000001819654780_li13555132516119>`.

11. .. _alm-50229__en-us_topic_0000001819654780_li13555132516119:
...
12. .. _alm-50229__en-us_topic_0000001819654780_li8194169123519:
