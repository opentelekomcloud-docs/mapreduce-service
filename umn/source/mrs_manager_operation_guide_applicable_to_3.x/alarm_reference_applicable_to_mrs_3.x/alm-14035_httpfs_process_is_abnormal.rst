...
#. Log in to FusionInsight Manager and choose **O&M** > **Alarm** > **Alarms**. Wait for about 10 minutes and check whether the alarm is automatically cleared.
   ...
   -  If the alarm is in the list, view the alarm details and record the IP address of the host where the alarm is generated. Run the command in :ref:`2 <alm-14035__li68511247311>`.

#. .. _alm-14035__li68511247311:
...
#. Check whether the command output contains any abnormal state (D, Z, or T).
   ...
   -  If the output contains any abnormal state, go to :ref:`5 <alm-14035__li39471558560>`.
   -  If the output does not contain abnormal states, go to :ref:`7 <alm-14035__li17799174711116>`.

#. .. _alm-14035__li39471558560:
...
#. Wait 5 minutes and check whether the alarm is cleared.
   ...
   -  If the alarm fails to be cleared, go to :ref:`7 <alm-14035__li17799174711116>`.

**Collect fault information.**

7.  .. _alm-14035__li17799174711116:
