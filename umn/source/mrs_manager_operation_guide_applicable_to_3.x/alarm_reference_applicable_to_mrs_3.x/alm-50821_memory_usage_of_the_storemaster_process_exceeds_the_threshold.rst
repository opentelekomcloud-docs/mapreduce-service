:original_name: ALM-50821.html

.. _ALM-50821:

ALM-50821 Memory Usage of the StoreMaster Process Exceeds the Threshold
=======================================================================

Alarm Description
-----------------

The system checks the StoreMaster memory usage every 30 seconds. This alarm is generated when the memory usage exceeds the threshold.

This alarm is cleared when the StoreMaster memory usage falls below the threshold.
...
#. Log in to MRS Manager and choose **O&M** > **Alarm** > **Thresholds** > **MemArtsStore** > **MEMORY** > **Master Process Memory Usage (StoreMaster)**.
...
#. Wait 2 minutes and check whether the alarm is automatically cleared.
   ...
   -  If no, go to :ref:`5 <alm-50821__en-us_topic_0000002488267382_en-us_topic_0000002157258612_li10360155511379>`.

**Collect fault information.**

5. .. _alm-50821__en-us_topic_0000002488267382_en-us_topic_0000002157258612_li10360155511379:
