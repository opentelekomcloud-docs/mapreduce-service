...
#. On MRS Manager, choose **O&M** > **Alarm** > **Thresholds** > **Impala** > **Query Task Sum Statistics** > **Total number of Queries Being Submitted (Impalad)** and check the threshold.
