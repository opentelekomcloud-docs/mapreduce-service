:original_name: ALM-50810.html

.. _ALM-50810:

ALM-50810 Number of StoreWorker Read Failures Due to Flow Control Exceeds the Threshold
=======================================================================================

Alarm Description
-----------------

The system checks the number of StoreWorker read failures due to flow control every 30 seconds. This alarm is generated when the number of read failures exceeds the threshold.

This alarm is cleared when the number of StoreWorker read failures due to flow control falls below the threshold.
...
#. On MRS Manager, choose **O&M** > **Alarm** > **Alarms**. In the alarm list, view the role name and obtain the IP address of the instance in **Location** of the alarm whose ID is **50810**.
...
#. Choose **Cluster** > **Services** > **MemArtsStore** > **Instances**, click the StoreWorker instance for which the alarm is generated, and click the **Chart** tab of the instance.
   ...
   -  If no, go to :ref:`3 <alm-50810__en-us_topic_0000002488107396_en-us_topic_0000002192819517_li148161194383>`.

**Check whether the alarm threshold or alarm trigger count is properly configured.**

3. .. _alm-50810__en-us_topic_0000002488107396_en-us_topic_0000002192819517_li148161194383:

   Log in to MRS Manager and choose **O&M** > **Alarm** > **Thresholds** > **MemArtsStore** > **Service** > **Number of Worker Read Failures Due to Flow Control (StoreWorker)**.
...
6. Wait 2 minutes and check whether the alarm is automatically cleared.
   ...
   -  If yes, no further action is required.
   -  If no, go to :ref:`7 <alm-50810__en-us_topic_0000002488107396_en-us_topic_0000002192819517_li10360155511379>`.

**Collect fault information.**

7.  .. _alm-50810__en-us_topic_0000002488107396_en-us_topic_0000002192819517_li10360155511379:
