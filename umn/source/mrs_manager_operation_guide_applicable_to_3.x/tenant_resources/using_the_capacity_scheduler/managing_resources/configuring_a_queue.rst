...
#. Set **Cluster** to the name of the target cluster. In **All tenants resources** area, locate the row that contains the target tenant resource and click **Modify** in the **Operation** column.
   ...
   .. table:: **Table 1** Queue configuration parameters
      ...
      +-----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Default AM Resource Pool Label                | If this parameter is configured, AM executes tasks on a node with a specified resource label. If this parameter is not configured, the default resource pool of the current queue is used. (This parameter is available in MRS 3.6.0 or later.)                                                                                                                                                                                         |
      +-----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
