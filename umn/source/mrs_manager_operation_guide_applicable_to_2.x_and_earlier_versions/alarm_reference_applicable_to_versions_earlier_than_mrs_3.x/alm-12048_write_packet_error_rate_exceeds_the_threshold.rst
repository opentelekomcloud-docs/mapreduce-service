...
#. Log in to MRS Manager and check whether the threshold (configurable, 0.5% by default) is appropriate.
   ...
   -  If yes, go to :ref:`4 <alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li12888339145357>`.
   -  If no, go to :ref:`2 <alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li15963175145357>`.

#. .. _alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li15963175145357:

   Choose **System** > **Threshold Configuration** > **Device** > **Host** > **Network Writing** > **Network Write Packet Rate Information** > **Write Packet Error Rate** and change the alarm threshold based on the actual service usage.

#. Wait 5 minutes and check whether the alarm is cleared.

   -  If yes, no further action is required.
   -  If no, go to :ref:`4 <alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li12888339145357>`.

**Check whether the network is normal.**

4. .. _alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li12888339145357:

   Contact the system administrator to check whether the network is normal.

   -  If yes, rectify the network fault and go to :ref:`5 <alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li60279330145357>`.
   -  If no, go to :ref:`6 <alm_12048__en-us_topic_0191813897_li572522141314>`.

5. .. _alm_12048__en-us_topic_0191813897_en-us_topic_0087039297_li60279330145357:
...
6. .. _alm_12048__en-us_topic_0191813897_li572522141314:
